...
def merge_te_data(year):
    print(f"\n🔄 Merging TE features for {year}...")
    ...
    rush_df = rush_df[rush_df['pos'] == 'TE']
    rec_df = rec_df[rec_df['pos'] == 'TE']
    ...
    output_path = os.path.join( f"te_{year}_features.csv")
...
if __name__ == "__main__":
    for year in YEARS:
        try:
            ...
            print(f"❌ Failed to merge TE {year}: {e}")
