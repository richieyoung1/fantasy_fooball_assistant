...
def main():
    print("\n📊 Training WR model using 2020–2024 data...")
    ...
    predictions.to_csv("wr_2025_predictions.csv", index=False)
    print("✅ WR 2025 predictions saved to wr_2025_predictions.csv")
